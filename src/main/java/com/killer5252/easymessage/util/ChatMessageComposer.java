...
public class ChatMessageComposer {
    ...
    public void send(boolean prefix) {
        try {
            ...
            EasyMessage.instance().getLogger().warn("Failed to send chat message");
            e.printStackTrace();
        }
    }
    ...
    static {
        IChatComponent name1 = new ChatComponentText("Easy");
        IChatComponent name2 = new ChatComponentText("Message");
